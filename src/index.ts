...
program
    ...
    .option('--from <date>', 'only shows activity on or after this date (format: YYYY-MM-DD)')
    .option('--to <date>', 'only shows activity on or before this date (format: YYYY-MM-DD)')
